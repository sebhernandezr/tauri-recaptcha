...
impl<R: Runtime> Recaptcha<R> {
  pub fn do_recaptcha_challenge(&self) -> Result<(), PluginInvokeError> {
    self
      .0
      .run_mobile_plugin("doRecaptchaChallenge", ())
  }

  pub fn close_recaptcha_challenge(&self) -> Result<(), PluginInvokeError> {
    self
        .0
        .run_mobile_plugin("closeRecaptchaChallenge", ())
  }
}
